...
Vehicles have a AV stat, which represents their armour. They also sometimes have hardened plasma shielding and point-defense. Vehicles may move and fire Heavy and Very Heavy weapons at full FS. Unless they have a listed WS stat, they are hit automatically in melee and may not make melee attacks. If they have a WS stat, they do close combat as normal. Vehicles do not normally gain Cover Saves from Terrain.</description>
  ...
  <sharedRules>
    ...
    <rule id="45b2-2626-3775-6ad7" name="Fast" hidden="false">
      <description>This unit moves a further 2&quot; extra when issued the Advance Order or when Charging, and gains +1&quot; to Pile In Moves.</description>
    </rule>
    ...
    <rule id="5c0d-855c-51f7-77f7" name="Incineration (x)" hidden="false">
    ...
    <rule id="2dab-a7af-aaf7-45ea" name="Anti-Air" hidden="false">
      <description>This Weapon can fire at non-hovering Aircraft. When targeting Flying units, this weapon ignores the FS penalty from the Ability.</description>
    </rule>
    ...
    <rule id="4e9b-aabc-f5b4-c229" name="Blast (x)" hidden="false">
      <description>When attacking, this Weapon makes 1 attack per every Squad or Vehicle in the target unit, to a maximum of x.</description>
    </rule>
    ...
    <rule id="8ee7-9315-8b62-2af6" name="Walking Terror" hidden="false">
      <description>Enemy Units in Close Combat Range of this Unit reduce their Ld by 2.</description>
    </rule>
    ...
    <rule id="69a5-9eb2-99bd-9167" name="Scavenge" hidden="false">
      <description>When an enemy Unit is destroyed within 24&quot; of this Unit, place a token on one of the Squads or Vehicles to be destroyed. When this unit is within 2&quot; of that token, it may do an Action and gain one of the following:
...
- The Unit gains one of the Wargear of the enemy unit, within the restrictions given by the Wargear.</description>
    </rule>
    ...
    <rule id="95bb-698d-55d1-0096" name="Bodyguard" hidden="false">
      <description>This unit must be taken as an option for an HQ unit, akin to a Transport Selection. If taken this way, it takes up no unit slot. In addition, when joined by an HQ Unit, it can re-roll any failed hit rolls (Guided weapons instead gain +1 BS) and every time a Squad in this Unit with this Ability would take Damage, roll a d6 for each point of Damage. On a 6+, it does not take that Damage.</description>
    </rule>
    ...
    <rule id="eab6-cf5e-1838-2760" name="Thunderous Charge (x)" hidden="false">
      <description>When a Model in a Unit with this Ability Charges an enemy Unit, it can immediately make x unarmed close combat attacks (if x is 1, then even if the profile says 2 attacks, they only make 1).</description>
    </rule>
...
- Models in a Unit with this Ability double their Mv and gain +1 Ws until the end of the Round.</description>
    ...
    <rule id="f0be-b368-bd26-5fb5" name="Panic (x)" hidden="false">
      <description>When making a Leadership Test for Suppression or Rout caused by a Weapon with this Keyword, that Enemy&apos;s Leadership is reduced by x for that roll. </description>
    </rule>
    ...
    <rule id="bade-290c-0399-184e" name="Fire Support Craft" hidden="false">
      <description>When not Hovering, this Aircraft ignores the fire arc restriction.</description>
    </rule>
    <rule id="0afc-3456-e623-24bc" name="Ordnance" hidden="false">
      <description>This weapon must be fired as Indirect Fire. When doing so, do not make normal attacks. Instead, note down the target, and next round, when this Unit can Fire, the normal attack sequence happens. When scattering, roll 4d3&quot;, reducing to 2d3&quot; if this Unit has the Take Aim Order.</description>
    </rule>
  </sharedRules>
</gameSystem>